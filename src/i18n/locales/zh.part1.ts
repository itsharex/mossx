    ...
    computerUse: {
      ...
      authorizationContinuity: {
        ...
        body: {
          ...
          unsupported_context: "当前 backend / launcher context 无法提供稳定的 authorization host。先切回能稳定承载 Codex CLI 的本地 packaged app context，再重试。",
      ...
      broker: {
        ...
        continuityBlockedNotice: "当前 authorization continuity 已断裂或当前 context 不受支持。先修复 exact host 身份，再运行 broker。",
