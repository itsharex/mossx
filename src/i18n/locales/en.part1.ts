    ...
    computerUse: {
      ...
      authorizationContinuity: {
        ...
        body: {
          ...
          unsupported_context: "The current backend or launcher context cannot provide a stable authorization host. Switch back to the local packaged app context that actually runs Codex CLI, then retry.",
      ...
      broker: {
        ...
        continuityBlockedNotice: "Authorization continuity is broken or the current context is unsupported. Fix the exact host identity before running the broker.",
